...
// determines weather the number has been liked before and either increments the like count or appends a new like to the list.
function likeNumber() {
...
// As a user, I can pause the counter, which should
  ...
  function commentSection() {
    ...
    function createCommentNode(){
      ...
      node.innerText = document.getElementById('comment-input').value;
      return node;
    };
  }